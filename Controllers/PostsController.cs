...
namespace CodeWithFilza.Controllers
{
    public class PostsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BlogId,Title,Abstract,Content,ReadyStatus,Image")] Post post)
        {
            ...
            {
                // post.Created = DateTime.Now; //current date
                post.Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc); //postgre doesnt store datetimes with a timezone
                _context.Add(post);
